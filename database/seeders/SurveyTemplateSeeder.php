        ...
        $templates = [
            [
                ...
                'json_schema' => json_encode([
                    ...
                    ['type' => 'radio-group', 'label' => 'Overall, how satisfied were you with your experience?', 'name' => 'overall_satisfaction', 'values' => [
                    ...
                    ['type' => 'radio-group', 'label' => 'How likely are you to purchase from us again?', 'name' => 'repurchase_intent', 'values' => [
            ...
            [
                ...
                'json_schema' => json_encode([
                    ...
                    ['type' => 'radio-group', 'label' => 'Do you currently use a similar product?', 'name' => 'current_usage', 'values' => [
                        ['label' => 'Yes', 'value' => 'yes'],
                        ['label' => 'No', 'value' => 'no'],
                    ]],
                    ['type' => 'text', 'label' => 'How much would you be willing to pay for this new solution?', 'name' => 'price_point'],
                    ['type' => 'checkbox-group', 'label' => 'Which features are most important to you?', 'name' => 'features', 'values' => [
            ...
            [
                ...
                'json_schema' => json_encode([
                    ...
                    ['type' => 'radio-group', 'label' => 'Originality of the work', 'name' => 'originality', 'values' => [
                    ...
                    ['type' => 'radio-group', 'label' => 'Recommendation', 'name' => 'recommendation', 'values' => [
            ...
            [
                ...
                'json_schema' => json_encode([
                    ...
                    ['type' => 'radio-group', 'label' => 'How easy was it to use the product?', 'name' => 'ease_of_use', 'values' => [
                        ['label' => 'Very Easy', 'value' => '5'],
                        ['label' => 'Somewhat Easy', 'value' => '3'],
                        ['label' => 'Difficult', 'value' => '1'],
                    ]],
                    ['type' => 'checkbox-group', 'label' => 'What did you like about the product?', 'name' => 'likes', 'values' => [
                        ['label' => 'Speed', 'value' => 'speed'],
                        ['label' => 'Price', 'value' => 'price'],
            ...
            [
                ...
                'json_schema' => json_encode([
                    ...
                    ['type' => 'radio-group', 'label' => 'Did the event meet your expectations?', 'name' => 'expectations', 'values' => [
