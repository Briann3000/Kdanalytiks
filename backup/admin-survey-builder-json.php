...
<div class="w3-container w3-padding">
    <h2 class="w3-text-blue"><i class="fa fa-plus-circle"></i> Survey Builder (jQuery Form Builder)</h2>
    ...
    <?php if (isset($success)): ?>
        ...
        <a href="admin-dashboard.php" class="w3-button w3-blue w3-margin-top">Back to Dashboard</a>
    <?php else: ?>
            ...
            <div class="w3-col l3 w3-margin-bottom">
                <div class="w3-card w3-white w3-padding w3-round">
                    ...
                    <form method="post" id="surveyForm">
                        ...
                        <a href="admin-dashboard.php" class="w3-button w3-red w3-block w3-margin-top">Cancel</a>
                    </form>
                </div>
            </div>
