...
<div class="w3-container w3-padding">
    <h2 class="w3-text-purple"><i class="fa fa-plus-circle"></i> Create Survey</h2>
    ...
    <form method="post" class="w3-card w3-white w3-padding w3-round">
        ...
        <h3 class="w3-text-purple w3-margin-top">Questions</h3>
        <div id="questions-container">
            <!-- Questions will be added here dynamically -->
        </div>
        
        <button type="button" class="w3-button w3-purple w3-margin-top" onclick="addQuestion()">
        ...
        <div class="w3-margin-top">
            ...
            <a href="independent-dashboard.php" class="w3-button w3-red w3-round">Cancel</a>
        </div>
    </form>
</div>
