...
if ($independent){
    ...
    die("Access Denied: You do not have an active Independent profile.");
}
...
<div class="w3-container w3-padding">
    <h2 class="w3-text-purple"><i class="fa fa-list"></i> My Surveys</h2>
    
    <div class="w3-margin-bottom">
        <a href="independent-survey-builder.php" class="w3-button w3-purple w3-round">
                ...
                <tbody>
                    <?php foreach ($surveys as $survey): ?>
                        <tr>
                            ...
                            <td>
                                <a href="independent-responses.php?survey_id=<?php echo $survey->id; ?>" class="w3-button w3-small w3-purple">View Responses</a>
                                <a href="independent-reports.php?survey_id=<?php echo $survey->id; ?>" class="w3-button w3-small w3-green">Reports</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
