        ...
        try {
            ...
            $allPages = [
                'admin' => [
                    ...
                    'admin-survey-builder' => ['url' => route('admin.surveys.create'), 'label' => 'Create Public Survey', 'desc' => 'build, create new public survey, add questions, designer, constructor'],
                ...
                'organization' => [
                    ...
                    'org-surveys' => ['url' => route('organization.surveys.index'), 'label' => 'My Surveys', 'desc' => 'list, view all my surveys, owned surveys, manage surveys'],
                    'org-create-survey' => ['url' => route('organization.surveys.create'), 'label' => 'Create Survey', 'desc' => 'build, create new survey, add questions, form builder, start new research'],
                ...
                'independent' => [
                    ...
                    'ind-surveys' => ['url' => route('independent.surveys.index'), 'label' => 'My Surveys', 'desc' => 'list, view all my surveys, research list, manage research'],
                    'ind-create-survey' => ['url' => route('independent.surveys.create'), 'label' => 'Create Survey', 'desc' => 'build, create new research survey, design questions, researcher tool'],
            ...
            $systemPrompt = "You are KM Agent — the autonomous AI agent for KMSurveyTool, a survey platform.\n\n" .
                "User: {$name} | Role: {$role}\n\n" .
