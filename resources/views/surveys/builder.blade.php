    ...
    <div x-data="surveyBuilder" class="relative min-h-screen pb-20">
        ...
        <div id="importModal" x-show="showImportModal" x-cloak
            ...
            <div class="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden"
                ...
                <div class="p-8 bg-white">
                    <p class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-4 font-bold">Select a Word
                    ...
                    <div
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-gray-400 font-bold uppercase mt-1">Supports standard Word
                                    Document (.docx)</p>
                            </div>
                        </div>
                    </div>
