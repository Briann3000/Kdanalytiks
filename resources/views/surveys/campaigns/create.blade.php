        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <form action="{{ route('surveys.campaigns.store', $survey) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="p-6 bg-gray-50/50 border border-gray-100 rounded-2xl space-y-3">
                        ...
                        <div class="pt-2">
                            <input type="file" name="csv_file" id="csv_file" accept=".csv,.txt"
                                class="block w-full text-xs text-gray-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-[10px] file:font-black file:uppercase file:tracking-wider file:bg-indigo-50 file:text-indigo-600 hover:file:bg-indigo-100 transition-all cursor-pointer">
                        </div>
                        @error('csv_file')
                            <p class="text-rose-500 text-[10px] font-bold mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="p-6 bg-gray-50/50 border border-gray-100 rounded-2xl space-y-3">
                        ...
                        <textarea name="emails" id="emails" rows="3"
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all"
                ...
                <div class="pt-6 border-t border-gray-50 flex items-center justify-end space-x-3">
                    ...
                    <button type="submit"
                        class="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-indigo-100 transition-all transform hover:-translate-y-1">
