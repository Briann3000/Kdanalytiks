<div
    ...
    <div class="px-8 py-5 border-b border-white/5 bg-[#222] flex items-center justify-between">
        <div class="flex items-center gap-3">
            <div
                class="w-8 h-8 rounded-xl bg-gradient-to-tr from-blue-500 to-[#2271b1] flex items-center justify-center shadow-lg shadow-[#2271b1]/20">
        ...
        <button @click="switchReportTab('analyse')"
            class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/5 text-[10px] font-bold tracking-wider text-slate-300 hover:bg-white/10 hover:text-white transition-all">
    ...
    <!-- Main Content Area -->
    <div class="flex-1 p-8 grid lg:grid-cols-2 gap-8 items-start bg-[#161616]">

        <!-- Left Panel: Original Text & Analysis -->
        <div class="flex flex-col gap-6">
            <div class="rounded-2xl border border-white/5 bg-[#222]/50 p-6 flex flex-col gap-4 shadow-sm relative">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <!-- Hidden Upload Form -->
                        <input type="file" id="report-humanizer-file-input" class="hidden"
                            accept=".docx,.pdf,.txt,.csv,.xlsx" @change="uploadFile($event)">
                        <button @click="document.getElementById('report-humanizer-file-input').click()"
                            class="text-[10px] text-[#2271b1] hover:text-[#2271b1] font-black tracking-wider transition-colors">
            ...
            <div class="rounded-2xl border border-white/5 bg-[#222]/50 p-6 flex flex-col gap-5 shadow-sm"
                            ...
                            <ul class="flex flex-col gap-1.5">
                                <template x-for="rec in originalAnalysis.recommendations">
                                    <li class="flex items-start gap-2 text-[11px] text-slate-300 leading-relaxed">
                                        <i class="fa-solid fa-circle-info text-indigo-400 text-[10px] mt-0.5"></i>
            ...
            <div class="rounded-2xl border border-white/5 bg-[#222]/50 p-6 flex flex-col gap-4 shadow-sm relative">
                ...
                <div
                    ...
                    <div x-show="isHumanizing"
                        class="absolute inset-0 bg-[#161616]/95 flex flex-col items-center justify-center gap-3 z-30 animate-in fade-in duration-150">
                        ...
                        <span
                            class="text-[9px] text-slate-500">{{ __('Varying rhythm and purging vocabulary signatures...') }}</span>
                    </div>
