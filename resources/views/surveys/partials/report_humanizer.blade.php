<div class="w-full bg-[#1c1c1c] text-slate-100 flex flex-col font-sans overflow-y-auto custom-scrollbar"
    ...
    <div class="flex-1 p-8 grid grid-cols-1 lg:grid-cols-[1fr_52px_1fr] gap-0 lg:gap-0 items-start bg-[#161616]">
        ...
        <div class="hidden lg:flex flex-col items-center justify-start pt-[22rem]">
            <div class="flex flex-col items-center gap-2">
                <button x-show="humanizerResult.trim()" x-transition:enter="transition ease-out duration-300"
                    ...
                    @click="humanizerOriginal = humanizerResult; humanizerResult = ''; humanizedAnalysis = null; originalAnalysis = null; $nextTick(() => { analyzeHumanizerText(); })"
        ...
        <div class="flex lg:hidden justify-center my-2">
            <button x-show="humanizerResult.trim()"
                @click="humanizerOriginal = humanizerResult; humanizerResult = ''; humanizedAnalysis = null; originalAnalysis = null; $nextTick(() => { analyzeHumanizerText(); })"
            ...
            <div class="rounded-2xl border border-white/5 bg-[#222]/50 p-6 flex flex-col gap-4 shadow-sm relative">
                ...
                <div class="relative">
                    ...
                    <div x-show="isHumanizing"
                        class="absolute inset-0 bg-[#161616]/95 flex flex-col items-center justify-center gap-3 z-30 animate-in fade-in duration-150 rounded-xl">
