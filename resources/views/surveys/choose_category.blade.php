        ...
        <div class="max-w-5xl w-full">
            ...
            <form action="{{ route('surveys.initialize') }}" method="POST" id="categoryForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    @foreach($categories as $key => $cat)
                        <label class="relative group cursor-pointer">
                            ...
                            <div
                                class="h-full bg-white border-2 border-gray-100 rounded-3xl p-6 transition-all duration-300 hover:border-indigo-500 hover:shadow-xl hover:shadow-indigo-500/5 peer-checked:border-indigo-600 peer-checked:bg-indigo-50/20 peer-checked:ring-4 peer-checked:ring-indigo-600/5 flex flex-col">
                                <div
                ...
                <div class="mt-12 flex justify-center">
                    <button type="submit"
                        class="px-12 py-5 bg-indigo-600 text-white rounded-2xl font-black text-xs uppercase tracking-[0.3em] shadow-2xl shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-1 transition-all flex items-center group">
