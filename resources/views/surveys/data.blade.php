    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
            <div>
                ...
                <p class="text-[11px] text-gray-400 font-medium mt-0.5">Showing all verified submissions for this project.
                </p>
            </div>
                        ...
                        @foreach($responses as $response)
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="text-[10px] font-black text-gray-900 uppercase tracking-tight">{{ $response->respondent ? $response->respondent->name : 'Anonymous' }}</span>
                                </td>
        ...
        @else
            <div class="p-20 text-center">
                ...
                <p class="text-[10px] text-gray-300 font-bold uppercase italic">Data will appear here once the survey is
                    deployed and responses start coming in.</p>
            </div>
        @endif
    </div>
@endsection