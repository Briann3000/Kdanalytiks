                                                    ...
                                                    @foreach($item['stats'] as $stat)
                                                        @if(!isset($stat['is_missing']) || !$stat['is_missing'])
                                                            ...
                                                            <td
                                                                ...
                                                                {{ number_format($stat['count']) }}</td>
                                                            <td
                                                                class="hidden sm:table-cell py-3 px-2 text-center text-xs font-normal text-gray-900 border-r border-gray-200">
                                                                {{ number_format($percentLikert, 1) }}%</td>
                                                            <td
                                            ...
                                            <tbody class="divide-y divide-gray-200">
                                                ...
                                                @foreach($item['stats'] as $stat)
                                                    ...
                                                    <tr class="hover:bg-gray-50/30 transition-colors border-b border-gray-100">
                                                        ...
                                                        <td
                                                            class="py-2 sm:py-2.5 px-2 sm:px-4 text-right text-[10px] sm:text-xs font-normal text-gray-900 border-r border-gray-200">
                                                            {{ number_format($percent, 1) }}%</td>
                                                        <td
                                                            class="py-2 sm:py-2.5 px-2 sm:px-4 text-right text-[10px] sm:text-xs font-normal text-gray-900 border-r border-gray-200">
                                                            {{ $validPercent !== null ? number_format($validPercent, 1) . '%' : '-' }}</td>
                                                        <td
                                                            class="py-2 sm:py-2.5 px-2 sm:px-4 text-right text-[10px] sm:text-xs font-normal text-gray-900 border-r border-gray-200">
                                                            {{ $cumPercentDisplay }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                            ...
                            @else
                                <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100 text-center mt-6">
                                    ...
                                    <p class="text-xs text-gray-500 font-medium">
                                        {{ __('Upgrade to Pro to unlock automated trend interpretation for numerical data.') }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
                                            ...
                                            <select x-model="rowVar"
                                                ...
                                                @foreach($analysis as $item)
                                                    <option value="{{ $item['id'] }}">
                                                        {{ \Illuminate\Support\Str::limit($item['label'], 60) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div>
                                    ...
                                    <div class="border-b border-gray-100 pb-4 flex justify-between items-center">
                                        <div>
                                            <h4 class="text-lg font-black text-gray-900">
                                                {{ __('Cross-Tabulation Contingency Table') }}</h4>
                                            <p class="text-xs text-gray-500 mt-1"
                            ...
                            <div class="space-y-8 animate-in fade-in duration-500">
                                <div class="bg-white p-6 sm:p-8 border border-gray-100 shadow-sm space-y-6">
                                    <div class="border-b border-gray-100 pb-4 flex justify-between items-center">
                                        <div>
                                            <h4 class="text-lg font-black text-gray-900">
                                                {{ __('Chi-Square for Independence ') }}</h4>
                                            ...
                                            <table class="w-full text-left border-collapse min-w-[500px]">
                                                ...
                                                <tbody>
                                                    ...
                                                    <template x-if="(chisquareData || matrixData).linearAssociation">
                                                        <tr class="hover:bg-gray-50/50">
                                                            <td class="p-3 border-b text-xs font-semibold text-gray-800">
                                                                {{ __('Linear-by-Linear Association') }}</td>
                                                            <td class="p-3 border-b text-xs font-medium text-gray-700 text-center"
                            ...
                            <div class="space-y-8 animate-in fade-in duration-500">
                                <div class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-6">
                                    <div class="border-b border-gray-100 pb-4 flex justify-between items-center">
                                        <div>
                                            <h4 class="text-lg font-black text-gray-900">
                                                {{ __("Reliability Analysis (Cronbach's Alpha α)") }}</h4>
                                            <p class="text-xs text-gray-500 mt-1">
                                                {{ __('Internal consistency assessment across scale items') }}</p>
                                        </div>
                                        <span
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
                                        ...
                                        <div class="p-5 bg-indigo-50/50 rounded-2xl border border-indigo-100">
                                            <span
                                                class="text-[10px] font-black text-indigo-600 uppercase tracking-widest">{{ __('Standardized Alpha (α_std)') }}</span>
                                        ...
                                        <div class="p-5 bg-gray-50 rounded-2xl border border-gray-200">
                                            <span
                                                class="text-[10px] font-black text-gray-500 uppercase tracking-widest">{{ __('Items Evaluated (K)') }}</span>
                                        ...
                                        <div class="p-5 bg-blue-50/50 rounded-2xl border border-blue-100">
                                            <span
                                                class="text-[10px] font-black text-blue-600 uppercase tracking-widest">{{ __('Valid Cases (N)') }}</span>
                                    ...
                                    <template x-if="cronbachData.item_stats && cronbachData.item_stats.length > 0">
                                        <div class="mt-6 border-t border-gray-100 pt-6 space-y-3">
                                            <h5 class="text-sm font-black text-gray-900">
                                                {{ __('Item-Total Statistics Table') }}</h5>
                                            <div class="overflow-x-auto">
                                                <table class="w-full text-left border-collapse min-w-[600px]">
                                                    <thead>
                                                        <tr class="bg-gray-50 font-bold text-gray-700 text-xs">
                                                            ...
                                                            <th class="p-3 border-b text-center">
                                                                {{ __('Scale Mean if Item Deleted') }}</th>
                                                            <th class="p-3 border-b text-center">
                                                                {{ __('Scale Variance if Item Deleted') }}</th>
                                                            <th class="p-3 border-b text-center">
                                                                {{ __('Corrected Item-Total Correlation') }}</th>
                                                            <th class="p-3 border-b text-center">
                                                                {{ __("Cronbach's Alpha if Item Deleted") }}</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                ...
                                <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="w-full text-left border-collapse min-w-[800px]">
                                            <thead>
                                                <tr
                                                    class="bg-gray-50 font-bold text-gray-700 text-[10px] uppercase tracking-wider">
                                                    <th class="p-3 border-b" rowspan="2"></th>
                                                    <th class="p-3 border-b text-center border-r" colspan="2">
                                                        {{ __("Levene's Test for Equality of Variances") }}</th>
                                                    <th class="p-3 border-b text-center" colspan="7">
                                                        {{ __('t-test for Equality of Means') }}</th>
                                                </tr>
                                                <tr
                                                    class="bg-gray-50 font-bold text-gray-700 text-[10px] uppercase tracking-wider">
                                                    ...
                                                    <th class="p-3 border-b text-center">
                                                        {{ __('95% Confidence Interval (Lower)') }}</th>
                                                    <th class="p-3 border-b text-center">
                                                        {{ __('95% Confidence Interval (Upper)') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr class="hover:bg-gray-50/50 transition-colors">
                                                    <td class="p-3 border-b text-xs font-semibold text-gray-800">
                                                        {{ __('Equal variances assumed') }}</td>
                                                    <td class="p-3 border-b text-xs font-medium text-gray-600 text-center"
                                                ...
                                                <tr class="hover:bg-gray-50/50 transition-colors">
                                                    <td class="p-3 border-b text-xs font-semibold text-gray-800">
                                                        {{ __('Equal variances not assumed') }}</td>
                                                    <td class="p-3 border-b text-xs font-medium text-gray-600 text-center">
                                                    </td>
                                                    <td
                                            ...
                                            <thead>
                                                <tr class="bg-gray-50 font-bold text-gray-700 text-xs">
                                                    ...
                                                    <th class="p-3 border-b text-center border-l" colspan="2">
                                                        {{ __('95% Confidence Interval for Mean') }}</th>
                            ...
                            <div class="space-y-8 animate-in fade-in duration-500">
                                <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                                        ...
                                        <table class="w-full text-left border-collapse">
                                            <thead>
                                                <tr class="bg-gray-50 font-bold text-gray-700 text-xs">
                                                    ...
                                                    <th class="p-3 border-b text-center">
                                                        {{ __('Std. Error of the Estimate') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                    ...
                                    <h5 class="text-sm font-black text-gray-900 mb-4">
                                        {{ __('ANOVA (Regression significance)') }}</h5>
                                    <div class="overflow-x-auto mb-8">
                                        <table class="w-full text-left border-collapse">
                                            <thead>
                                                <tr class="bg-gray-50 font-bold text-gray-700 text-xs">
                            ...
                            <div class="space-y-8 animate-in fade-in duration-500">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h5 class="text-[9px] font-black text-indigo-300 uppercase tracking-widest">
                                                {{ __('Computed Regression Model Equation') }}</h5>
                        ...
                        <template
                            ...
                            <div
                                ...
                                <button @click="copyResultsToClipboard()"
                                    class="px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2">
                                    <i class="fa-solid fa-copy"></i> {{ __('Copy Results to Clipboard') }}
                                </button>

                                <div class="flex items-center gap-3">
                                    <span
                                        class="text-[10px] font-bold text-gray-400 uppercase tracking-wider">{{ __('Continue Analysis Flow:') }}</span>
                                    <template x-if="testMethod === 'correlation'">
                                        <button
                                    ...
                                    <div class="relative z-10 flex flex-col md:flex-row gap-6 items-start">
                                        ...
                                        <div class="w-full">
                                            <h5 class="text-sm font-black text-indigo-600 mb-3">
                                                {{ __('Statistical Intelligence') }}</h5>
