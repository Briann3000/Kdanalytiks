...
@section('meta_description', \Illuminate\Support\Str::limit(strip_tags($survey->description ?? 'Participate in this survey on KDAnalytiks to help collect and analyze data, and compile and report findings.'), 150))
                        ...
                        <script>
                            ...
                            window.onload = function () {
                                ...
                                const processedSchema = surveyData.map(field => {
                                    ...
                                    // Numbering
                                    if (!['header', 'paragraph', 'hidden', 'note', 'group'].includes(field.type) && field.label) {
