                    ...
                    <form id="jsonSurveyForm" action="{{ route('surveys.submit', $survey->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div id="surveyContainer" class="bg-gray-50/50 p-8 rounded-2xl border border-gray-100 shadow-sm mb-6">
                            <div id="surveyLoading" class="flex flex-col items-center justify-center py-20">
                                ...
                                <p class="text-gray-500 font-medium tracking-wide">Initializing Survey Experience...</p>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
                                ...
                                <div class="flex-grow w-full">
                                    <input type="text" name="captcha" required placeholder="Enter the characters above"
                                        class="w-full px-5 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 transition-all text-gray-700 shadow-sm" id="jsonCaptchaInput">
                    ...
                    <form id="legacySurveyForm" action="{{ route('surveys.submit', $survey->id) }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                                ...
                                <div class="ml-12">
                                    ...
                                    @if ($question->type === 'text')
                                        <input type="text" name="{{ $inputName }}" {{ $question->required ? 'required' : '' }}
                                            class="w-full px-5 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all text-gray-700 shadow-sm">
                                    
                                    @elseif ($question->type === 'textarea')
                                        <textarea name="{{ $inputName }}" rows="4" {{ $question->required ? 'required' : '' }}
                                            class="w-full px-5 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all text-gray-700 shadow-sm"></textarea>
                                    ...
                                    @elseif ($question->type === 'email')
                                        <input type="email" name="{{ $inputName }}" {{ $question->required ? 'required' : '' }}
                                            class="w-full px-5 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 transition-all text-gray-700 shadow-sm" placeholder="your@email.com">
                                    ...
                                    @elseif ($question->type === 'video')
                                        <div class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl bg-white hover:border-indigo-400 transition-colors">
                                            <div class="space-y-2 text-center">
                                                <i class="fa-solid fa-video text-gray-400 text-3xl mb-2"></i>
                                    ...
                                    @elseif ($question->type === 'audio')
                                        <div class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl bg-white hover:border-indigo-400 transition-colors">
                                            <div class="space-y-2 text-center">
                                                <i class="fa-solid fa-microphone text-gray-400 text-3xl mb-2"></i>
                                                <div class="flex text-sm text-gray-600 justify-center">
                                                    <label class="relative cursor-pointer bg-white rounded-md font-bold text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 text-center">
                                                ...
                                                <p class="text-xs text-gray-500">MP3, WAV, OGG up to 20MB</p>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                        ...
                        @empty
                            <div class="text-center py-16 bg-gray-50 rounded-2xl border border-dashed border-gray-300">
                                ...
                                <p class="text-gray-500 font-medium">This survey has no questions defined yet.</p>
                            </div>
                        @endforelse
