...
@section('content')
    <div class="w-full">
        ...
        <div class="relative">
            ...
            <header
                class="sticky top-0 z-50 bg-gray-100 border-b border-gray-100 flex items-center justify-between px-10 py-5">
                <div>
                                    ...
                                    @foreach($responses as $response)
                                        <tr class="hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                @endphp
                                                <span
                                                    class="px-2 py-0.5 rounded-md text-[10px] font-black uppercase border {{ $class }}">
                                                    {{ $sentiment }}
                                                </span>
                                            </td>
