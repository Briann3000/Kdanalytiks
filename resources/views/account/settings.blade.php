...
<div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <div class="mb-12">
        <h1 class="text-3xl font-black text-gray-900 uppercase tracking-tight">Account Settings</h1>
        <p class="text-gray-500 font-medium mt-2">Manage your profile details and global research branding.</p>
    </div>
    ...
    @if($errors->any())
        <div class="mb-8 p-4 bg-red-50 border border-red-100 rounded-2xl animate-in fade-in slide-in-from-top-4 duration-500">
            <p class="text-xs text-red-700 font-bold uppercase tracking-widest mb-2 flex items-center">
                <i class="fa-solid fa-circle-exclamation mr-2 text-base"></i> Please fix the errors below:
            </p>
    ...
    <form action="{{ route('account.settings.profile') }}" method="POST" class="space-y-8 mb-12">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden">
            <div class="px-10 py-8 border-b border-gray-50 bg-slate-50/30 flex justify-between items-center">
                <div>
                    <h3 class="text-xs font-black text-gray-400 uppercase tracking-widest">Personal Profile</h3>
                    <p class="text-[11px] text-gray-400 font-bold mt-1">Your basic identification and contact info.</p>
                </div>
            ...
            <div class="p-10 space-y-8">
                ...
                <div>
                    <h4 class="text-xs font-black text-gray-900 uppercase tracking-widest mb-6">Security & Password</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="relative">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden">
            <div class="px-10 py-8 border-b border-gray-50 bg-indigo-50/20 flex justify-between items-center">
                <div>
                    <h3 class="text-xs font-black text-indigo-600 uppercase tracking-widest flex items-center gap-2">
                        <i class="fa-solid fa-palette"></i> Research Branding
                    </h3>
                    <p class="text-[11px] text-gray-400 font-bold mt-1">Configure global branding for your generated reports and proposals.</p>
                </div>
            ...
            <div class="p-10 space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div class="space-y-8">
                        <div>
                            <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4">Export Logo</label>
                            <div class="flex items-center gap-6">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-[9px] text-gray-400 font-bold mt-2 uppercase tracking-tight">
                                        PNG or JPG, Max 2MB. 
                                        @if($user->export_logo_url)
                                            <span class="text-indigo-600">✓ Current logo saved.</span>
                                        @endif
                                    </p>
                                </div>
                            </div>
                        ...
                        <div>
                            <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Default Organization Name</label>
                            ...
                            <p class="text-[9px] text-gray-400 font-bold mt-2 uppercase tracking-tight">Used in report footers and title pages.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="p-8 rounded-[2rem] border {{ $canCustom ? 'border-indigo-100 bg-indigo-50/10' : 'border-gray-100 bg-gray-50/30' }}">
                            <div class="flex items-start justify-between gap-4">
                                <div class="flex-1">
                                    <h5 class="text-xs font-black {{ $canCustom ? 'text-indigo-900' : 'text-gray-400' }} uppercase tracking-widest mb-1">Remove KMSurvey Branding</h5>
                                    <p class="text-[10px] font-bold {{ $canCustom ? 'text-indigo-400' : 'text-gray-400' }} uppercase tracking-tighter leading-relaxed">
                                        Remove "Exported via KMSurveyTool" from all your professional reports and proposals.
                                    </p>
                                </div>
                        ...
                        @if(!$canCustom)
                            <div class="p-6 rounded-2xl bg-amber-50 border border-amber-100">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <span class="text-[10px] font-black text-amber-900 uppercase tracking-widest">Premium Feature</span>
                                </div>
                                <p class="text-[9px] text-amber-700 font-bold uppercase tracking-tight leading-relaxed">
                                    You are currently on a free plan. Upgrade to a premium subscription to remove our branding and use your own custom logo.
                                </p>
