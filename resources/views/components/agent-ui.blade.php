...
<!-- Trigger -->
<button id="kda-btn" title="{{ __("KDA Autonomous Agent") }}">
...
<div id="kda-panel">
    ...
    <div class="kda-chips">
        ...
        @if ($role === 'admin')
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Create a survey about customer feedback") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Go to manage users") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Show me reports") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Go to payments") }}</span>
        @elseif ($role === 'organization')
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Create a survey about employee satisfaction") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Show me responses") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Take me to reports") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Manage my surveys") }}</span>
        @elseif ($role === 'independent')
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Create a survey about climate change") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Show me responses") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Take me to reports") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Manage my surveys") }}</span>
        @elseif ($role === 'respondent')
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Show my available surveys") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("View my submitted responses") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Go to dashboard") }}</span>
        @else
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Login as organization") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Register as researcher") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("Browse public surveys") }}</span>
            <span class="kda-chip" onclick="kmaChip(this)">{{ __("What is KDAnalytiks?") }}</span>
        @endif
    </div>
    ...
    <div class="kda-inp-wrap">
        <textarea id="kda-inp" rows="1" placeholder="{{ __("Tell me what to do — I'll navigate and fill for you...") }}"
        ...
        (function () {
            ...
            function executeAction(data) {
                ...
                const btnHtml = isPrefill
                    ? `<button onclick="window.location.href='${url}'" style="margin-top:10px;background:#2e7d32;color:#fff;border:none;padding:6px 12px;border-radius:6px;cursor:pointer;font-weight:bold;width:100%;"><i class="fa fa-external-link-alt"></i> {{ __("Launch Survey Builder") }}</button>`
                    : '';
