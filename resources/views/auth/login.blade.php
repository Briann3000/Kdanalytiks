...
@section('title', __($roleLabel . ' Login'))
                ...
                <form class="space-y-6" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('password.request') }}"
                                class="font-medium text-[#2271b1] hover:text-zinc-2000">{{ __('Forgot your password?') }}</a>
                        </div>
                    </div>
                    ...
                    <div>
                        <button type="submit"
                            ...
                            <i class="fa-solid fa-sign-in-alt mt-0.5 mr-2"></i> {{ __('Sign in') }}
                        </button>
                    </div>
                </form>
                ...
                @if($role != 'admin')
                    <div class="mt-6">
                        ...
                        <div class="mt-6 text-center">
                            <a href="{{ route('register', ['role' => $roleName]) }}"
                                class="text-sm font-medium text-[#2271b1] hover:text-zinc-2000">
                                {{ __('Create a new :role account', ['role' => __($roleLabel)]) }}
                            </a>
                        </div>
                    </div>
                @endif
