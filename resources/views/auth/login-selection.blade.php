        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-5xl px-4">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <a href="{{ route('login.role', ['role' => 'organization', 'redirect' => request('redirect')]) }}"
                    class="group relative bg-white rounded-3xl shadow-sm border border-gray-100 p-10 text-center transition-all hover:shadow-2xl hover:-translate-y-2 hover:border-zinc-300">
                    <div
                        class="mx-auto h-20 w-20 flex items-center justify-center rounded-[2rem] bg-zinc-100 text-[#2271b1] group-hover:bg-[#2271b1] group-hover:text-white transition-all duration-500 mb-8 transform group-hover:rotate-6">
                    ...
                    <div class="mt-8 flex justify-center">
                        <span
                            class="text-[#2271b1] text-xs font-black uppercase tracking-widest group-hover:translate-x-2 transition-transform">{{ __('Get Started') }}
                ...
                <a href="{{ route('login.role', ['role' => 'respondent', 'redirect' => request('redirect')]) }}"
                    ...
                    <div class="mt-8 flex justify-center">
                        <span
                            class="text-[#2271b1] text-xs font-black uppercase tracking-widest group-hover:translate-x-2 transition-transform">{{ __('Start Earning') }}
                            <i class="fa-solid fa-arrow-right ml-2"></i></span>
                    </div>
                </a>
            </div>
