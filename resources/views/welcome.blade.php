...
@section('meta_description', 'KDAnalytiks is an AI-powered research platform that helps users collect data,run statistical analysis and compile automated reports.')
