        ...
        <div class="max-w-full mx-auto">
            <header class="mb-8 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-500 font-medium">Define your research vision and let AI draft the formal
                        documentation.</p>
                </div>
            ...
            <form action="{{ route('research-proposal.store') }}" method="POST" class="space-y-8" id="proposalForm"
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 border-b border-gray-50 pb-8">
                        <div>
                            ...
                            <p class="mt-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest">List 3-5 clear
                                objectives.</p>
                        </div>
                        <div>
                            <label for="scope"
                            ...
                            <div
                                ...
                                <div class="relative z-10">
                                    ...
                                    <p class="text-[10px] text-indigo-100 font-bold opacity-80 uppercase leading-relaxed">
                                        The generator will produce Intro, Problem Statement, Methodology, and Timeline
                ...
                <div class="flex items-center justify-between pt-4">
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest max-w-xs">
                        By proceeding, the synthesis engine will analyze your inputs and generate a structured draft. This
                        can take up to 60 seconds.
                    </p>
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('research-proposal.index') }}"
                            class="px-8 py-4 rounded-2xl text-xs font-black text-gray-500 uppercase tracking-widest hover:bg-gray-100 transition-all">Cancel</a>
