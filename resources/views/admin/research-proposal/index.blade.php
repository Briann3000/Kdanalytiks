            ...
            <div class="max-w-4xl mx-auto space-y-8">
                ...
                <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                    <div class="h-12 border-b border-gray-100 px-6 flex items-center bg-gray-50/50">
                        <span
                            class="text-xs font-bold text-gray-700 uppercase tracking-wider">{{ __('Report Configuration') }}</span>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="space-y-6">
                                    <div>
                                        ...
                                        <p class="mt-2 text-[11px] text-gray-400 italic font-medium px-1">
                                            {{ __('Selected data will be processed through the qualitative analysis pipeline.') }}
                                        </p>
                                    </div>
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <p class="text-[10px] text-gray-400 font-medium">
                                                    {{ __('Auto-identifying recurring research themes') }}</p>
                                            </div>
                                        </div>
                                        <div
                                            class="flex items-center p-4 bg-gray-50 border border-transparent rounded-xl hover:border-indigo-100 transition-all">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-[10px] text-gray-400 font-medium">
                                                    {{ __('Generating in-text academic references') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-8" x-data="{ 
                                ...
                                <div class="space-y-4">
                                    <template x-for="(ref, index) in references" :key="index">
                                        <div
                                            class="p-4 bg-white border border-gray-100 rounded-xl shadow-sm relative group">
                                            <button type="button" @click="removeReference(index)"
                                    ...
                                    <div x-show="references.length === 0"
                                        class="text-center py-8 border-2 border-dashed border-gray-100 rounded-2xl">
                                        <p class="text-xs text-gray-400 font-medium italic">
                                            {{ __('No manual references added. AI will rely on general knowledge.') }}</p>
                                    </div>
                                </div>
                            </div>

                            <div
                                class="flex flex-col sm:flex-row items-center justify-between sm:justify-end space-y-4 sm:space-y-0 sm:space-x-4 pt-6 border-t border-gray-100">
                                <div
                                    class="flex items-center space-x-2 text-gray-400 w-full sm:w-auto justify-center sm:justify-start">
