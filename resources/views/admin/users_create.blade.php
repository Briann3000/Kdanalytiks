...
<div class="max-w-3xl mx-auto px-4 sm:px-0">
    <div class="mb-8">
        ...
        <p class="mt-1 text-sm text-gray-500">Add a new user to the system with a specific role and access level.</p>
    </div>
    ...
    <div class="bg-white shadow rounded-lg border border-gray-100 overflow-hidden">
        <form action="{{ route('admin.users.store') }}" method="POST" class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <label for="role" class="block text-sm font-bold text-gray-700 uppercase tracking-wider">Role</label>
            ...
            <div class="pt-6 border-t border-gray-100 flex items-center justify-between">
                <a href="{{ route('admin.users.index') }}" class="text-sm font-medium text-gray-400 hover:text-gray-600 transition-colors">
                    Cancel and return
                </a>
                <button type="submit"
