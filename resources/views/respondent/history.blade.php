...
@section('title', __('My Survey History'))

@section('content')
    <div class="px-4 sm:px-0">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 leading-tight">{{ __('My Survey History') }}</h2>
                <p class="mt-1 text-sm text-gray-500">{{ __('View the surveys you have previously participated in.') }}</p>
            </div>
            <div>
            ...
            <ul role="list" class="divide-y divide-gray-200">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex flex-col items-end gap-1">
                                <span
                                    ...
                                    <i class="fa-solid fa-check mr-1.5"></i> {{ __('Completed') }}
                                </span>
                ...
                @empty
                    <li class="py-12 px-6 text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-900">{{ __('No History Yet') }}</h3>
                        <p class="mt-2 text-sm text-gray-500 max-w-sm mx-auto">
                            {{ __("You haven't completed any surveys. Head over to the Public Marketplace to get started!") }}
                        </p>
                        <div class="mt-6">
